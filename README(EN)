...
Libraries Used
This firmware incorporates the following files published by Indoor Corgi:
...
🎥 Demo Video (YouTube)
This video demonstrates simultaneous IR transmission and Wi‑Fi communication using this custom firmware and sample code.
You can see the Pico2W actually controlling an air conditioner.
